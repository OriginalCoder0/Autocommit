...
[autoCommit](https://github.com/OBKoro1/autoCommit)是兴之所至（OBKoro1）创建的个人项目，仅用于学习交流，禁止任何人商用以及用于非法之途。
...
如果插件觉得还不错的话，就给个 [Star](https://github.com/OBKoro1/autoCommit) ⭐️ 鼓励一下原创作者吧~  
[autoCommit](https://github.com/OBKoro1/autoCommit)
